...
hero_image: "./hero.jpg"
hero_image_alt: "me, contemplating how to get out of vim again"
hero_image_credit_text: "Tim Gouw"
hero_image_credit_link: "https://www.pexels.com/photo/man-in-white-shirt-using-macbook-pro-52608/"
tags: ["git", "software development", "web dev", "version control", "time travel"]

---

# Git is complicated...
Git can sometimes make your head spin. I know I am safe in assuming that I'm not alone in this feeling because sites like ['Oh Shit Git'](https://ohshitgit.com) exist.

    ![ohshitgit_com](./ohshitgit.jpg)
...
Developers also can use `git worktree` for quickly reacting to production issues or other urgent matters requiring a hot-fix. This workflow illustrates how that is accomplished:
```bash
