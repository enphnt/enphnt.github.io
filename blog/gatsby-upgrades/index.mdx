---
title: "Upgrading this very Gatsby blog (v1 => v4)"
date: "2023-02-02"
...
To overcome these, I found that it's necessary to add Gatsby peer dependencies to the `package.json` for some unknown reason. I saw there was a bit of chatter about dependencies issues on Gatsby's Github [issues](https://github.com/gatsbyjs/gatsby/discussions/35313). [Here](https://github.com/gatsbyjs/gatsby/issues/25708), I saw I could just bypass issues with the transient dependencies and just specify compatible versions myself in the `package.json` like so:
