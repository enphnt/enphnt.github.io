...
#### lang="en"
  ...
  However, this lead to SSR issues due to mismatch between server/client. So, I recommend using the `gatsby-ssr.js` to set the language of the page to English:
  ```js
...
![Screenshot of the head section of a webpage](./head.png)
