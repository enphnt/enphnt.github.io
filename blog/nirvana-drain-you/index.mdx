...
### Break
A one-chord build is performed for the break in this song. The noisier harmonies can be achieved by playing the F♯ chord shape with only the top 3 strings of the guitar (a power chord) and then leaving the bottom strings open so they ring and include the flat 6 (D) note which gives it a forboding sound.
