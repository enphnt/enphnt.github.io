...
hero_image_credit_link: "https://www.bing.com/images/create/a-programmer-creating-a-new-musical-instrument2c-in/1-656bc2477e37437682e7d92665b8e6d8?id=yFqbWV50GTEUGXWSAJF8pg%3d%3d&view=detailv2&idpp=genimg&noidpclose=1&FORM=SYDBIC"
...
I'll also share some of the pitfalls and surprises that I learned along the way like how Apple has their own proprietary format (Audio Units) and how this could be handled programmatically to support both VST and AU formats from a single codebase.
...
Interestingly, JUCE uses tiers to determine your license:
