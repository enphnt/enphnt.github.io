...
# About this exercise
  Mastering the Major 7 chord in all keys is like unlocking a new level in your musical journey. This exercise is your key to glide effortlessly through complex chord progressions, with your fingers dancing all over the fretboard. 
  
  By dedicating time to this exercise, you're investing in yourself as a musician. You're arming yourself with the tools to express your musical ideas fluently, improvise freely, and appreciate music on a deeper level. This exercise challenges you to step out of your comfort zone, strive for improvement, and experience the joy (and struggle) of progress. 
  
  So, are you ready to embark on this exciting musical adventure?
...
## The Major 7 fingering pattern
  ...
  <GuitarTablature 
    title={
      <>
        <div style={{fontSize: "1.5rem"}}>Major 7 Arpeggios</div>
...
There is a clear opportunity to expand this exercise so it covers more chord qualities. In the future, I plan to cover the following chord types: 
    - [Major 7](../arpeggio-stamina-practice) (this exercise)
    - [minor 7](../arpeggio-minor7)
    - minor Major 7 
    - Major 7(♯5) 
    - minor 7(♭5)
    - Dominant 7
