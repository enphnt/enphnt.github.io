...
Today, I'll be following along the [Gatsby SEO guide](https://www.gatsbyjs.com/docs/how-to/adding-common-features/adding-seo-component/#seo-with-gatsby). I'll be following these steps roughly:
