...
hero_image: "./hero.jpg"
hero_image_alt: "some google things on a phone that will be outdated soon ...oops, too late"
hero_image_credit_text: "Czapp Árpád"
hero_image_credit_link: "https://www.pexels.com/photo/a-black-android-smartphone-with-google-apps-on-screen-10774600/"
tags: ["gcp", "google cloud platform", "web dev", "backend", "gcloud"]
...
## What is it?
It's a NoSQL-style database. It automatically handles things like [sharding](https://en.wikipedia.org/wiki/Shard_(database_architecture)) and replication and so it's highly available, durable and will automatically scale to handle the real-time load of an app. It offers a few ways of doing business like SQL-like querying, [ACID](https://en.wikipedia.org/wiki/ACID) (atomic, consistent, isolated, durable) transactions and indexes.

<div className={note}>
  <strong>Note:</strong> Datastore is already on the way out! Soon all data stores will be automatically upgraded to Firestore, a faster more consistent solution.
</div>
...
### Browse your new app: 'gcloud app browse'
    ...
    ![gcloud-app-browse-datastore.png](./gcloud-app-browse-datastore.png)
...
### Inspect the Datastore via the console
    ...
    ![datastore-entities.png](./datastore-entities.png)
