...
hero_image: "./hero.png"
hero_image_alt: "instagram + gatsby = gatinstagramsby?"
...
1. Search for `profilePage_`. The number that follows is the username id. If you view the page source of https://www.instagram.com/username/, you will find `profilePage_8556131572`. So, `8556131572` is the username id of the username `username`.
