...
Before you start, I recommend watching this video, or atleast the beginning:
  ...
  <div style={{textAlign: "center", padding: "20px 0"}}>
    <iframe width="560" height="315" src="https://www.youtube.com/embed/kTNfi5z6Uvk?origin=https://enphnt.github.io" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
  </div>
